...
namespace Cerberus.Dashboard.Persistence.Migrations
{
    ...
    [Migration("20220113121102_add_role_accountrole_permission_rolepermission_tables")]
    partial class add_role_accountrole_permission_rolepermission_tables
    {
            ...
            modelBuilder.Entity("Cerberus.Dashboard.Domain.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8343),
                            Description = "Has a super user access level granted can do anything",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8351),
                        ...
                        new
                        {
                            Id = 2,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8354),
                            Description = "Can do basic things not everything",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8354),
                            ModifyUserId = "builder.seed",
                        ...
                        new
                        {
                            Id = 3,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8356),
                            Description = "Can only view data can not modify data",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 36, DateTimeKind.Local).AddTicks(8357),
                            ModifyUserId = "builder.seed",
            ...
            modelBuilder.Entity("Cerberus.Dashboard.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 31, DateTimeKind.Local).AddTicks(1897),
                            Description = "An administrator role normaly does everything",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(8831),
                            ModifyUserId = "builder.seed",
                            RoleName = "Admin",
                            StatusId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9325),
                            Description = "An dean role of the university generaly views only.",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9328),
                            ModifyUserId = "builder.seed",
                            RoleName = "Dean",
                            StatusId = 1
                        },
                        new
                        {
                            Id = 3,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9330),
                            Description = "An dean role of the university views their own department.",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9331),
                            ModifyUserId = "builder.seed",
                            RoleName = "Lecturer",
                            StatusId = 1
                        },
                        new
                        {
                            Id = 4,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9332),
                            Description = "An Faculty officer role of the university views their own faculty.",
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 35, DateTimeKind.Local).AddTicks(9333),
                            ModifyUserId = "builder.seed",
            ...
            modelBuilder.Entity("Cerberus.Dashboard.Domain.Models.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1040),
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1046),
                            ModifyUserId = "builder.seed",
                            PermissionId = 1,
                            RoleId = 1,
                            StatusId = 1
                        ...
                        new
                        {
                            Id = 2,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1048),
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1049),
                            ModifyUserId = "builder.seed",
                            PermissionId = 3,
                            RoleId = 2,
                            StatusId = 1
                        ...
                        new
                        {
                            Id = 3,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1051),
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1052),
                            ModifyUserId = "builder.seed",
                            PermissionId = 2,
                            RoleId = 3,
                            StatusId = 1
                        ...
                        new
                        {
                            Id = 4,
                            CreateUserId = "builder.seed",
                            CreatedDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1053),
                            IsActive = true,
                            ModifyDate = new DateTime(2022, 1, 13, 14, 11, 2, 37, DateTimeKind.Local).AddTicks(1054),
                            ModifyUserId = "builder.seed",
                            PermissionId = 2,
                            RoleId = 4,
                            StatusId = 1
